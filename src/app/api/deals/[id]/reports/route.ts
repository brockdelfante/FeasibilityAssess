...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    switch(type) {
        case 'mezzanine': element = React.createElement(MezzanineAssessment, { data }); break;
        case 'client': element = React.createElement(ClientSummary, { data }); break;
        case 'cashflow': element = React.createElement(CashflowReport, { cashflow: data.results.cashflow }); break;
        case 'sensitivity':
            ...
            break;
        default: element = React.createElement(CreditSummaryReport, { data }); break;
    }
